...
async function main() {
  console.log("🚀 Deploying Sport Performance Protocol contracts to BNB Smart Chain...\n");
  ...
  console.log(`SPP_TOKEN_ADDRESS=${tokenAddress}`);
  console.log(`PERFORMANCE_ORACLE_ADDRESS=${oracleAddress}`);
  console.log(`DEFLATINARY_BURN_ADDRESS=${burnAddress}`);
  console.log(`REWARD_TIERS_ADDRESS=${tiersAddress}`);
  console.log();

  // 9. Verification commands
  console.log("🔐 To verify contracts on BscScan, run:");
  console.log(`\nnpx hardhat verify --network bscMainnet ${tokenAddress} "${initialSupply}"`);
  console.log(`npx hardhat verify --network bscMainnet ${oracleAddress}`);
  console.log(`npx hardhat verify --network bscMainnet ${burnAddress} "${tokenAddress}" "${oracleAddress}"`);
  console.log(`npx hardhat verify --network bscMainnet ${tiersAddress}`);
  console.log();
